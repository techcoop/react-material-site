...
export const CookieNotice = props => showNotice(props.acceptKey) ? React.createElement("div", {
  id: props.acceptKey,
  className: cN('tc-cookie-notice', props.className),
  style: props.style
  ...
  className: "tc-cookie-notice__toolbar"
}, props.policyText && props.policyUrL && React.createElement(Button, {
  text: props.policyText,
  to: props.policyUrL,
  style: props.policyStyle
